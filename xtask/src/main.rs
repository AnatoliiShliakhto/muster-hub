...
use crate::models::args::{AppAction, AppCommands, Cli, FeatureAction, LibraryAction};
...
fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        AppCommands::License { customer, machines, matches, features, days } => {
            handlers::license::generate_license(&customer, &machines, matches, &features, days)?;
        },
    }
