...
fn validate_config(config: &LoggerConfig, name: &str) -> Result<()> {
...
fn build_env_filter(config: &LoggerConfig) -> Result<EnvFilter> {
...
mod tests {
    ...
    #[test]
    #[serial]
    fn test_logger_builder_configuration() -> Result<()> {
