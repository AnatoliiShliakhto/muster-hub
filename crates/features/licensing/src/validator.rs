...
use crate::{LicenseError, LicenseErrorExt, MachineConstraint, Result, SignedLicense};
...
pub fn validate_license(license: &SignedLicense, key: &[u8; 32]) -> Result<()> {
    // 1. Check expiry
...
fn verify_signature(license: &SignedLicense, public_key: &[u8; 32]) -> Result<()> {
