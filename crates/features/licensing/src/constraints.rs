...
fn build_component(component: HWIDComponent) -> Result<String> {
...
pub fn generate_machine_id_compound() -> Result<String> {
...
pub fn parse_machine_id_compound(s: &str) -> Result<Vec<String>> {
...
/// or parsed.
pub fn current_machine_components() -> Result<Vec<String>> {
